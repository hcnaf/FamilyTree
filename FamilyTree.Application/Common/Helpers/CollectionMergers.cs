...
{
    public static class CollectionMergers
    {
        public static class CollectionsMerger
        {
            public static MergeStatistics Merge<TDst, TSrc, TKey>(IEnumerable<TDst> original, IEnumerable<TSrc> updated, Func<TDst, TKey> getOriginalKey, Func<TSrc, TKey> getUpdatedKey, Action<TSrc> add = null, Action<TDst, TSrc> update = null, Action<TDst> remove = null)
            {
